...
GLAME ma być odpowiednikiem GIMP-a do obróbki dźwięku. Jego twórcy
chcą dać w pełni funkcjonalny, szybki, stabilny i łatwo rozszerzalny
edytor dźwięk dla Linuksa i kompatybilnych z nim systemów.
...
Wtyczka dla GLAME pozwalająca na odtwarzanie dźwięku przez ALSA.
...
Wtyczka dla GLAME pozwalająca na odtwarzanie dźwięku przez ESD.
